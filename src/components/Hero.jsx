...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto overflow-hidden">
      ...
      {/* Hero Text */}
      <div
        className={`${styles.paddingX} absolute inset-0 top-[100px] sm:top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 z-10 pointer-events-none`}
      >
        <div className="flex flex-col justify-center items-center mt-5">
          <div className="w-5 h-5 rounded-full bg-[#915EFF]" />
          <div className="w-1 sm:h-80 h-24 violet-gradient" />
        </div>
      ...
      {/* Computer 3D */}
      <div className="absolute inset-x-0 bottom-0 top-[220px] sm:top-[180px] z-10 pointer-events-auto">
  <ComputerCanvas />
</div>
      {/* Scroll Down */}
